              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-12 items-center">
                <div className="md:col-span-2">
                  ...
                  <p className="text-gray-600 mb-4">
                    ...
                    💼, where I&apos;ve been working on a Loan Evaluation
                    Application using technologies like Java 17, TypeScript,
              ...
              <div className="max-w-3xl mx-auto">
                <div className="flex flex-col md:flex-row gap-8">
                  ...
                  <div className="md:w-2/3">
                    <p className="text-gray-600 mb-4">
                      Working a part-time Fullstack Developer in the
                      Counterparty developing Loan Evaluation Application (LEAP)
                    </p>
        ...
        <footer id="footer" className="bg-dark-bg py-8">
          <div className="container mx-auto px-6 flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm mb-4 md:mb-0">
              &copy; {new Date().getFullYear()} Adam Lisner. All rights
              reserved.
            </p>
